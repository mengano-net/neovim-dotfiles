...
_G.packer_plugins = {
  ...
  ["glow.nvim"] = {
    loaded = true,
    needs_bufread = false,
    path = "/home/ec2-user/.local/share/nvim/site/pack/packer/opt/glow.nvim",
  ...
  ["nvim-lsp-installer"] = {
    ...
    loaded = true,
    path = "/home/ec2-user/.local/share/nvim/site/pack/packer/start/nvim-lsp-installer",
  ...
  ["twilight.nvim"] = {
    loaded = true,
    path = "/home/ec2-user/.local/share/nvim/site/pack/packer/start/twilight.nvim",
